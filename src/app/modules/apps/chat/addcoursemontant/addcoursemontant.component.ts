...
@Component({
  selector: 'app-addcoursemontant',
  templateUrl: './addcoursemontant.component.html',
  styleUrls: ['./addcoursemontant.component.scss']
})
export class AddcoursemontantComponent implements OnInit {
 ...
 if(!this.errorfeildfile
   ...
   this.userService.AddMontantCourse(this.f,this.namefile).subscribe((rep:any)=>{
    console.log(rep)
   ...
   // this.allreadyexiste = true;
     this.cdr.detectChanges();
      ...
      // this.accesautorisation= true;
       ...
       this.success = true
       this.allreadyexiste = true;
       this.router.navigate(['/apps/chat/list-montantcourses']);
     }
     else{
