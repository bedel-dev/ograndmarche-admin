...
@Component({
  selector: 'app-addpublicite',
  templateUrl: './addpublicite.component.html',
  styleUrls: ['./addpublicite.component.scss']
})
export class AddpubliciteComponent implements OnInit {
 ...
 if(!this.errorfeildfile
   ...
   this.userService.AddPublicite(this.f,this.namefile).subscribe((rep:any)=>{
    console.log(rep)
   ...
   this.userService.UplaodIamge(this.file).subscribe((res)=>{
     console.log(res)
      ...
      // this.accesautorisation= true;
       ...
       this.success = true
       this.allreadyexiste = true;
       this.router.navigate(['/apps/chat/list-publicite']);
