...
@Component({
  selector: 'app-usergestions',
  templateUrl: './usergestions.component.html',
  styleUrls: ['./usergestions.component.scss']
})
export class UsergestionsComponent implements OnInit, OnDestroy {
...
changeCity($event: Event) {
  ...
  constructor(protected _notificationSvc: NotificationService,private authService: AuthService,private cdr: ChangeDetectorRef,private fb: FormBuilder,private userService:UserServiceService,)
  {
